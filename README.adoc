...
…are always welcome.
Don’t hesitate to submit a https://github.com/alexpensato/spring-simplicity/issues[bug report] or a https://github.com/alexpensato/spring-simplicity/pulls[pull requests].
